...
public class DataBase {
    ...
    private static final String BD_MASCOTA = String.format("%s %s(%s INTEGER NOT NULL PRIMARY KEY, %s TEXT NOT NULL, %s INTEGER NOT NULL)", CREATE_TABLE_IF_EXISTS, TABLE_MASCOTA, "idMascota", "nombre", "foto");
    private static final String BD_LIKE_MASCOTA = String.format("%s %s(%s INTEGER NOT NULL,%s INTEGER NOT NULL)", CREATE_TABLE_IF_EXISTS, TABLE_LIKE_MASCOTA, "idMascota", "voto");
    //endregion
